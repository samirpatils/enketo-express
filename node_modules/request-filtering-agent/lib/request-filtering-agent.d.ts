 ...
 * @param url
 */
export declare const useAgent: (url: string, options?: (https.AgentOptions & RequestFilteringAgentOptions) | undefined) => RequestFilteringHttpAgent | RequestFilteringHttpsAgent;
